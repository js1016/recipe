...
logman create trace "axinstallsvc" -ow -o axinstallsvc.etl -p "Microsoft-Windows-AxInstallService" 0xffffffffffffffff 0xff -nb 16 16 -bs 1024 -mode Circular -f bincirc -max 4096 -ets
logman create trace "windows_defender" -ow -o defender.etl -p "Microsoft-Windows-Windows Defender" 0xffffffffffffffff 0xff -nb 16 16 -bs 1024 -mode Circular -f bincirc -max 4096 -ets

logman create trace "smartscreen" -ow -o smartscreen.etl -p {52F82079-1974-4C67-81DA-807B892778BB} 0xffffffffffffffff 0xff -nb 16 16 -bs 1024 -mode Circular -f bincirc -max 4096 -ets
logman update trace "smartscreen" -p {5AF61464-71AD-4419-A92A-7766E9A5ABC3} 0xffffffffffffffff 0xff -ets
...
logman update trace "schannel" -p {1F678132-5938-4686-9FDC-C8FF68F15C85} 0xffffffffffffffff 0xff -ets
